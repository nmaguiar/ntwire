...
// presence alone.
func TestPathStatusRowRendersSelectionState(t *testing.T) {
	withData := pathStatusRow(wstransport.PathStatus{Name: "wss", Kind: wstransport.PathWSS, Healthy: true, Primary: true})
