...
1. **Native ntwire Client Portal**
   ...
   * Supports rich interactive actions, such as launching Chrome/Chromium in an isolated browser profile (`ntwire://open/<target_id>`) with automated SOCKS5 proxying. Transparent upstream SOCKS tunnels have no PAC support.
